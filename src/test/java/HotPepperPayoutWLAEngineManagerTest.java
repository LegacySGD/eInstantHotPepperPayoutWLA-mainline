...
public class HotPepperPayoutWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(HotPepperPayoutWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/HotPepperPayoutWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/HotPepperPayoutWLAIW/InitOutcome.xml").getDocumentElement();
